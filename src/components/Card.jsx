...
export default function Card({ title, imageSource, styles = {}, handleOnClick, id }) {
  return (
    <article
    ...
    >
      <div
        className="transition-all duration-300 group-hover:h-[50%] absolute w-full h-[100px] bg-red-900/90 rounded-md flex flex-col justify-around items-center pt-2 px-2 bottom-0 text-white"
      >
