import { GithubIcon, GmailIcon, LinkedInIcon, MediumIcon, StackOverflowIcon } from "./icons"
  ...
  return (
    <footer className="flex flex-flow justify-center md:justify-start gap-4 items-center px-[20px] w-full h-[80px] min-h-[80px] bg-sky-950 max-w-[1200px] mt-[50px]">
      ...
      <nav className="flex flex-flow gap-5 justify-start items-center">
        <Link href={"https://www.linkedin.com/in/pablodarde/"}>
          <LinkedInIcon />
        </Link>
        <Link href={"https://github.com/darde"}>
          <GithubIcon />
        </Link>
        <Link href={"https://stackoverflow.com/users/1703696/pablo-darde"}>
          <StackOverflowIcon />
        </Link>
        <Link href={"https://medium.com/@pablodarde"}>
          <MediumIcon />
        </Link>
        <Link href={"mailto:pablodarde@gmail.com"}>
          <GmailIcon />
        </Link>
      </nav>
    </footer>
